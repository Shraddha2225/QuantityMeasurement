...
public class TestQuantityMeasurement {
    ...
    public void givenNullForFeet_ShouldReturnFalse() {
        double FEET = quantityMeasurement.unitConversion(UnitType.FEET, 0);
    ...
    public void givenReference_ShouldReturnTrue() {
        ...
        referenceTwo.unitConversion(UnitType.FEET, 2);
        quantityMeasurement.unitConversion(UnitType.FEET, 2);
    ...
    public void givenFeetValue_WhenEqual_ShouldReturnTrue() {
        double result1 = quantityMeasurement.unitConversion(UnitType.FEET, 3);
        double result2 = quantityMeasurement.unitConversion(UnitType.FEET, 3);
    ...
    public void givenFeetValue_WhenNotEqual_ShouldReturnFalse() {
        double result1 = quantityMeasurement.unitConversion(UnitType.FEET, 3);
        double result2 = quantityMeasurement.unitConversion(UnitType.FEET, 6);
        boolean result = quantityMeasurement.valueCheck(result1, result2);
        Assert.assertEquals(false, result);
    }
    ...
    public void givenEqualValueForInch_ShouldReturnTrue() {
        double result1 = quantityMeasurement.unitConversion(UnitType.INCH, 0);
        double result2 = quantityMeasurement.unitConversion(UnitType.INCH, 0);
        boolean result = quantityMeasurement.valueCheck(result1, result2);
        Assert.assertEquals(true, result);
    }
    ...
    public void givenNullForInch_ShouldReturnFalse() {
        double Inch = quantityMeasurement.unitConversion(UnitType.INCH, 0);
    ...
    public void givenReferenceForInch_ShouldReturnTrue() {
        QuantityMeasurement referenceTwo = new QuantityMeasurement();
        referenceTwo.unitConversion(UnitType.INCH, 2);
        quantityMeasurement.unitConversion(UnitType.INCH, 2);
        Assert.assertEquals(quantityMeasurement, referenceTwo);
    }
    ...
    public void givenValueCheckForInch_WhenEqual_ShouldReturnTrue() {
        double result1 = quantityMeasurement.unitConversion(UnitType.INCH, 3);
        double result2 = quantityMeasurement.unitConversion(UnitType.INCH, 3);
        boolean result = quantityMeasurement.valueCheck(result1, result2);
        Assert.assertEquals(true, result);
    }
    ...
    public void givenValueCheckForInch_WhenNotEqual_ShouldReturnFalse() {
        double result1 = quantityMeasurement.unitConversion(UnitType.INCH, 12);
        double result2 = quantityMeasurement.unitConversion(UnitType.INCH, 0);
        boolean result = quantityMeasurement.valueCheck(result1, result2);
        Assert.assertEquals(false, result);
    }
    ...
    public void givenValueCheckForInchAndFeet_WhenZero_ShouldReturnTrue() {
        double result1 = quantityMeasurement.unitConversion(UnitType.INCHTOFEET, 0);
        double result2 = quantityMeasurement.unitConversion(UnitType.FEETTOINCH, 0);
        boolean result = quantityMeasurement.valueCheck(result1, result2);
        Assert.assertEquals(true, result);
    }
    ...
    public void givenValueCheckFor1InchAnd1Feet_ShouldReturnTrue() {
        double result = quantityMeasurement.unitConversion(UnitType.INCHTOFEET, 1);
        Assert.assertNotEquals(1, result);
    }

    @Test
    public void givenValueCheckFor1FeetAnd1Inch_ShouldReturnTrue() {
        double result = quantityMeasurement.unitConversion(UnitType.FEETTOINCH, 1);
        Assert.assertNotEquals(1, result);
    }

    @Test
    public void givenValueCheckFor1FeetAnd12Inch_ShouldReturnTrue() {
        double result1 = quantityMeasurement.unitConversion(UnitType.FEETTOINCH, 1);
        Assert.assertEquals(12, result1, 0.0);
    }

    @Test
    public void givenValueCheckFor12InchAnd1Feet_ShouldReturnFalse() {
        double result = quantityMeasurement.unitConversion(UnitType.INCHTOFEET, 12);
        Assert.assertNotEquals(1, result);
    }

    @Test
    public void givenValueCheckFor3FeetTo1Yard_ShouldReturnTrue() {
        double result = quantityMeasurement.unitConversion(UnitType.FEETTOYARDS, 3);
        Assert.assertEquals(1, result, 0.0);
    }

    @Test
    public void givenValueCheckFor1FeetTo1Yard_WhenNotEqual_ShouldReturnTrue() {
        double result = quantityMeasurement.unitConversion(UnitType.FEETTOYARDS, 1);
        Assert.assertNotEquals(1, result);
    }

    @Test
    public void givenValueCheckFor1InchTo1Yard_ShouldReturnTrue() {
        double result = quantityMeasurement.unitConversion(UnitType.INCHTOYARDS, 1);
        Assert.assertNotEquals(1, result);
    }

    @Test
    public void givenValueCheckFor1YardToInch_ShouldReturnTrue() {
        double result = quantityMeasurement.unitConversion(UnitType.YARDSTOINCH, 1);
        Assert.assertEquals(36, result, 0.0);
    }

    @Test
    public void givenValueCheckFor36InchToYard_ShouldReturnTrue() {
        double result = quantityMeasurement.unitConversion(UnitType.INCHTOYARDS, 36);
        Assert.assertEquals(1, result, 0.0);
    }

    @Test
    public void givenValueCheckFor1YardToFeet_ShouldReturnTrue() {
        double result = quantityMeasurement.unitConversion(UnitType.YARDSTOFEET, 1);
        Assert.assertEquals(3, result, 0.0);
    }

    @Test
    public void givenValueCheckForInchToCentimetre_ShouldReturnTrue() {
        double result = quantityMeasurement.unitConversion(UnitType.INCHTOCENTIMETER, 2);
        Assert.assertEquals(5, result, 0.0);
    }

    @Test
    public void givenValueOfTwoFeet_WhenAdd_ShouldReturnTrue() {
        double feetToInch1 = quantityMeasurement.unitConversion(UnitType.FEETTOINCH, 1);
        double feetToInch2 = quantityMeasurement.unitConversion(UnitType.FEETTOINCH, 1);
    ...
    public void givenValueOfFeetAndInch_WhenAdd_ShouldReturnTrue() {
        double feetToInch1 = quantityMeasurement.unitConversion(UnitType.FEETTOINCH, 1);
        double inch = quantityMeasurement.unitConversion(UnitType.INCH, 2);
    ...
    public void givenValueOfTwoInches_WhenAdd_ShouldReturnTrue() {
        double inch1 = quantityMeasurement.unitConversion(UnitType.INCH, 2);
        double inch2 = quantityMeasurement.unitConversion(UnitType.INCH, 2);
    ...
    public void givenCentimeterAndInch_WhenAdd_ShouldReturnTrue() {
        double inch1 = quantityMeasurement.unitConversion(UnitType.INCH, 2);
        double inch2 = quantityMeasurement.unitConversion(UnitType.CENTIMETERTOINCH, 2.5);
        double add = inch1 + inch2;
    ...
    public void givenValueOfGallon_WhenCompare_ShouldReturnTrue() {
        double volume = quantityMeasurement.unitConversion(UnitType.GALLONTOLITRES, 1);
        Assert.assertEquals(3.78, volume, 0.0);
    }

    @Test
    public void givenValueInLitre_WhenCompare_ShouldReturnTrue() {
        double volume = quantityMeasurement.unitConversion(UnitType.LITRETOMILLILITRE, 1);
        Assert.assertEquals(1000, volume, 0.0);
    }

    @Test
    public void givenValueOfGallonAndLitre_WhenAdd_ShouldReturnTrue() {
        double volume = quantityMeasurement.unitConversion(UnitType.LITRE, 3.78);
        double volume1 = quantityMeasurement.unitConversion(UnitType.GALLONTOLITRES, 1);
    ...
    public void givenValueOfMilliLitreAndLitre_WhenAdd_ShouldReturnTrue() {
        double volume = quantityMeasurement.unitConversion(UnitType.LITRE, 1);
        double volume1 = quantityMeasurement.unitConversion(UnitType.MILLILITRETOLITER, 1000);
        double add = volume + volume1;
    ...
    public void givenValueINKillogram_WhenCompare_ShouldReturnTrue() {
        double weight = quantityMeasurement.unitConversion(UnitType.KILLOGRAMTOGRAM, 1);
        Assert.assertEquals(1000, weight, 0.0);
    }

    @Test
    public void givenValueInTonne_WhenCompare_ShouldReturnTrue() {
        double weight = quantityMeasurement.unitConversion(UnitType.TONNETOKILLLOGRAMS, 1);
        Assert.assertEquals(1000, weight, 0.00);
    }

    @Test
    public void givenValueInTonnesAndGram_WhenCompare_ShouldReturnTrue() {
        double weight1 = quantityMeasurement.unitConversion(UnitType.TONNETOKILLLOGRAMS, 1);
        double weight2 = quantityMeasurement.unitConversion(UnitType.GRAMTOKILLOGRAM, 1000);
    ...
    public void givenValueTemperature_WhenEquate_ShouldReturnTrue() {
        double celsius = quantityMeasurement.unitConversion(UnitType.CELSIUS, 100);
        Assert.assertEquals(212, celsius, 0.00);
    }
}